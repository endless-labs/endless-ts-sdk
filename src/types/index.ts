...
export enum MimeType {
   ...
   */
  BCS_SIGNED_TRANSACTION = "application/x.endless.signed_transaction+bcs",
  BCS_VIEW_FUNCTION = "application/x.endless.view_function+bcs",
}
 ...
 * {@link https://github.com/endless-labs/endless-core/blob/main/third_party/move/move-core/types/src/language_storage.rs#L27}
 */
 ...
 * {@link https://github.com/endless-labs/endless-core/blob/main/third_party/move/move-core/types/src/transaction_argument.rs#L11}
 */
 ...
 * {@link https://github.com/endless-labs/endless-core/blob/main/types/src/transaction/mod.rs#L478}
 */
 ...
 * {@link https://github.com/endless-labs/endless-core/blob/main/types/src/transaction/mod.rs#L440}
 */
 ...
 * {@link https://github.com/endless-labs/endless-core/blob/main/types/src/transaction/authenticator.rs#L44}
 */
...
/**
 * Transaction Authenticator enum as they are represented in Rust
 * {@link https://github.com/endless-labs/endless-core/blob/main/types/src/transaction/authenticator.rs#L414}
 */
 ...
 * behavior and interaction with the endless network
 */
...
export interface PaginationArgsOfIndexer {
  pageSize?: number;
  page?: number;
}
 ...
 *
 * @param API_KEY - api key generated from developer portal {@link https://developers.endlesslabs.com/manage/api-keys}}
...
export interface ClientRequest<Req> {
  ...
  contentType?: string;
  params?: any;
  overrides?: ClientConfig & FullNodeConfig & IndexerConfig;
 ...
 *
 * @param url - the url to make the request to, i.e https://fullnode.devnet.endlesslabs.com/v1
...
/**
 * A list of Authentication Key schemes that are supported by Endless.
 *
