...
/**
 * Type that holds all raw transaction instances Endless SDK supports
 */
...
export type InputEntryFunctionDataWithRemoteABI = InputEntryFunctionData & { endlessConfig: EndlessConfig };
/**
 ...
 */
export type InputViewFunctionDataWithRemoteABI = InputViewFunctionData & { endlessConfig: EndlessConfig };
