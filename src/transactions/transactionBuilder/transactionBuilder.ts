...
import { AnyPublicKey, AnySignature, KeylessPublicKey, KeylessSignature, Secp256k1PublicKey, Secp256k1Signature } from "../../core/crypto";
 ...
 *
 * @param args.transaction A endless transaction type to sign
...
export function getAuthenticatorForSimulation(publicKey: PublicKey) {
  ...
  if (publicKey instanceof KeylessPublicKey) {
    return new AccountAuthenticatorSingleKey(new AnyPublicKey(publicKey), new AnySignature(KeylessSignature.getSimulationSignature()));
  }
 ...
 */
const TRANSACTION_PREFIX = hashValues(["ENDLESS::Transaction"]);
